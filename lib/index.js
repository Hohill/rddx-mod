...
function ResolvePackagePathError(message) {
  Error.captureStackTrace(this, ResolvePackagePathError);
...
function RequireModuleError(message) {
  Error.captureStackTrace(this, RequireModuleError);
...
function ModuleHasNoPropertyError(message) {
  Error.captureStackTrace(this, ModuleHasNoPropertyError);
...
function ModHasBeenDestroyedError(message) {
  Error.captureStackTrace(this, ModHasBeenDestroyedError);
